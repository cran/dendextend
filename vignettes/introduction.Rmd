...
Both Baker's Gamma and cophenetic correlation (Which will be introduced shortly), can be calculated to create a corelation matrix using the `cor.dendlist` function (the default method is cophenetic correlation):
